...
function shouldSendNotification (today, lastNotification, lastBilledDate) {
...
module.exports = (reporter) => {
  reporter.beforeRenderListeners.insert({ after: 'billing' }, 'creditLimitNotifications', async (req, res) => {
    ...
    if (creditsUsed > creditsAvailable && shouldSendNotification(today, lastCreditLimitNotificationSentDate, lastBilledDate)) {
      try {
