...
module.exports = (reporter) => {
  reporter.beforeRenderListeners.add('creditLimitNotifications', (req, res) => {
      ...
      return reporter.multitenancyRepository.update({
        ...
        if (operation && operation.result.nModified === 1) {
          reporter.mailer({
            ...
            content: `Hello, The monthly prepaid credits in your jsreportonline account (${tenant.name}) has been exceeded. Please upgrade your jsreportonline plan to avoid service interruption, more information here: https://jsreport.net/buy/online. thank you, jsreportonline team`
          })
        }
      }).catch((e) => {
