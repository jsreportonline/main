...
module.exports = class MultitenancyRepository {
  ...
  async findTenantInExtension (email) {
    ...
    user.adminEmail = tenant.adminEmail
  ...
  async registerContactEmail (tenant, contactEmail) {
    ...
    delete this._cacheFind[tenant.email]
    delete this._cacheFindName[tenant.name]
  ...
  async registerTenant (email, name, password) {
    ...
    return Object.assign({}, tenant, { isAdmin: true, username: tenant.email, adminEmail: tenant.email })
  }
