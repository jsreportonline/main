...
module.exports = () => {
  ...
  // jsreport-electron-pdf return directory as .../lib where studio doesn't find studio folder
  // it needs PR with fix
  let electronInst = require('jsreport-electron-pdf')()
  electronInst.directory = path.join(electronInst.directory, '../')
  jsreport.use(electronInst)
