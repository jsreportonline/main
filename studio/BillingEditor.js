    ...
    return (
      <div className='block custom-editor' style={{ overflow: 'auto', minHeight: 0, height: 'auto' }}>
        ...
        <div>
          ...
          <a className='button confirmation' rel='noreferrer' style={{ display: 'inline-block', marginTop: '0.25rem', marginLeft: '0rem', marginRight: '1rem' }} href='https://gumroad.com/library' target='_blank'>
            Payment details
          </a>

          <a className='button danger' rel='noreferrer' style={{ display: 'inline-block', marginTop: '0.25rem', marginLeft: '0rem', marginRight: '1rem' }} href='https://gumroad.com/library' target='_blank'>
            Cancel subscription
          </a>

          <p>
            <small>
              We use <a href='https://gumroad.com' rel='noreferrer' target='_blank'>gumroad.com</a> to mange jsreportonline payments and subscriptions.
