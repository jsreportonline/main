...
/* harmony export */ });
/* harmony import */ var _chunks_helpers_segment_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5);
/*!
 * Chart.js v3.9.1
...
/* harmony import */ var _UpgradePlanGumroadModal_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
/* harmony import */ var _UpgradePlanModal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(9);
/* harmony import */ var react_chartjs_2__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(22);
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(4);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(17);
...
function isGumroad() {
  return (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.plan != null && (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.plan !== 'free' && (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.payments == null;
}
class BillingEditor extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor() {
    super(...arguments);
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "onFocus", () => {
      this.refresh();
    });
  }
  onTabActive() {
  ...
  async refresh() {
    ...
    this._loading = true;
    try {
      const tenant = await jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().api.get('/api/tenant');
      (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.plan = tenant.plan;
      (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.creditsAvailable = tenant.creditsAvailable;
      (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.payments = tenant.payments;
      this.forceUpdate();
    } finally {
      this._loading = false;
    }
  ...
  changePlan() {
    if (isGumroad()) {
      return jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().openModal(_UpgradePlanGumroadModal_js__WEBPACK_IMPORTED_MODULE_3__["default"]);
    }
    return jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().openModal(_UpgradePlanModal__WEBPACK_IMPORTED_MODULE_4__["default"], {
  ...
  openPaymentDetails(event) {
    ...
    if ((jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.payments) {
      return window.open(`https://jsreport.net/payments/customer/${(jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.payments.customer.uuid}`, '_blank');
    }
    event.preventDefault();
  }
  gumroadNote() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("small", null, "The older accounts uses ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", {
      href: "https://gumroad.com",
      rel: "noreferrer",
      target: "_blank"
    }, "gumroad.com"), " to mange jsreportonline payments and subscriptions. If you have any issues with payments, please contact gumroad support.", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("br", null), " If the plan upgrade is not propagated after several minutes, please contact jsreport support.", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("b", null, "Please cancel the old subscription when upgrading between payed plans.")));
  }
  planColor() {
    switch ((jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.plan) {
      case 'bronze':
        return '#00aba9';
      case 'silver':
        return '#647687';
  ...
  switchToOurBilling(e) {
    ...
    if (window.confirm('Billing from us is preferred, just please cancel your subscription at gumroad.com if you have one afterwards.')) {
      jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().openModal(_UpgradePlanModal__WEBPACK_IMPORTED_MODULE_4__["default"], {
        refresh: () => this.refresh(),
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h1", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("i", {
      className: "fa fa-home"
    }), " ", (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.name, " "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
      style: {
        marginBottom: '0.2rem'
      }
    }, "created on: ", jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication.user.tenant.createdOn.toLocaleDateString()), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
      style: {
        marginBottom: '0.2rem'
      }
    }, "admin email: ", (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.adminEmail), (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.contactEmail != null && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null, "contact email: ", (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.contactEmail)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h2", null, "current plan"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("button", {
      className: "button",
      style: {
        marginTop: '0.25rem',
        marginLeft: '0rem',
    ...
    }, (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.plan || 'free', " ", Math.round((jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.creditsUsed / 1000) + ' ', "/ ", (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.creditsAvailable, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("i", {
      style: {
        marginLeft: '0.5rem'
      },
      onClick: () => this.refresh(),
      className: "fa fa-refresh"
    })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h2", null, "manage subscription"), isGumroad() ? this.gumroadNote() : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null), (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.plan !== 'free' && (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.payments ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
      style: {
        marginBottom: '0.5rem'
      }
    }, "next payment: ", jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication.user.tenant.payments.customer.product.subscription.nextPayment.toLocaleDateString()) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("button", {
    ...
    }, "Change plan"), isGumroad() || (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.payments ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", {
      className: "button confirmation",
      rel: "noreferrer",
      enabl: true,
      style: {
      ...
      onClick: event => this.openPaymentDetails(event)
    }, "Manage payments") : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", null), isGumroad() ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", {
      className: "button confirmation",
      rel: "noreferrer",
      enabl: true,
      style: {
      ...
      onClick: event => this.switchToOurBilling(event)
    }, "Switch from gumroad to jsreport billing") : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", null)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h2", null, "billing history"), this.usageChart()));
  }
  usageChart() {
    const usageChartStart = (0,date_fns__WEBPACK_IMPORTED_MODULE_6__.subYears)(new Date(), 1);
    const usage = jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication.user.tenant.billingHistory.filter(h => h.billedDate > usageChartStart);
    usage.reverse();
    const data = {
      ...
      datasets: [{
        ...
        data: usage.map(h => (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.creditsAvailable),
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_chartjs_2__WEBPACK_IMPORTED_MODULE_7__.Line, {
      options: options,
      data: data
    });
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BillingEditor);
...
class UpgradePlanGumroadModal extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
      style: {
        width: '710px',
...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(UpgradePlanGumroadModal, "propTypes", {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (UpgradePlanGumroadModal);
...
/* harmony import */ var _UpgradePlanModal_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
/* harmony import */ var jsreport_studio__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(0);
/* harmony import */ var jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(jsreport_studio__WEBPACK_IMPORTED_MODULE_2__);



class UpgradePlanModal extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor(props) {
    super(props);
    this.state = {
      selected: (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.plan || 'free'
    };
  }
  async submit() {
    // /api/payments/customer/:customerId/subscription/:productId
    if (this.state.selected === 'free' && (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.plan != null && (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.plan !== 'free') {
    ...
    if (!this.props.options.allowSelectCurrent && ((jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.plan || 'free') === this.state.selected) {
      return this.props.close();
    }
    if (window.confirm('We will now navigate you to the payment form')) {
      this.props.close();
      window.open(`https://jsreport.net/payments/checkout/email/${encodeURIComponent((jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.email)}/jsreportonline/${this.state.selected}`);
    }
  }
  change(selected) {
    this.setState({
  ...
  render() {
    const currentPlan = (jsreport_studio__WEBPACK_IMPORTED_MODULE_2___default().authentication).user.tenant.plan || 'free';
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      style: {
        width: '710px'
      }
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Select plan to upgrade"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      className: _UpgradePlanModal_css__WEBPACK_IMPORTED_MODULE_1__["default"].plans
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      onClick: () => this.change('free'),
      style: {
        backgroundColor: '#60a917'
      },
      className: this.state.selected === 'free' ? _UpgradePlanModal_css__WEBPACK_IMPORTED_MODULE_1__["default"].selected : ''
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "FREE"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "monthly price"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "0 $ / no card"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "monthly credits *"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "200")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      onClick: () => this.change('bronze'),
      style: {
        backgroundColor: '#00aba9'
      },
      className: this.state.selected === 'bronze' ? _UpgradePlanModal_css__WEBPACK_IMPORTED_MODULE_1__["default"].selected : ''
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "BRONZE"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "monthly price"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "29.95 $"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "monthly credits *"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "10 000")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      onClick: () => this.change('silver'),
      style: {
        backgroundColor: '#647687'
      },
      className: this.state.selected === 'silver' ? _UpgradePlanModal_css__WEBPACK_IMPORTED_MODULE_1__["default"].selected : ''
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "SILVER"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "monthly price"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "99.95 $"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "monthly credits *"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "100 000")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      onClick: () => this.change('gold'),
      style: {
        backgroundColor: '#e3c800'
      },
      className: this.state.selected === 'gold' ? _UpgradePlanModal_css__WEBPACK_IMPORTED_MODULE_1__["default"].selected : ''
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "GOLD"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "monthly price"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "299.95 $"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("hr", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", null, "monthly credits *"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "300 000"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
      className: "button confirmation",
      style: {
        marginTop: '0.5rem',
        marginLeft: '5px'
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (UpgradePlanModal);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"plans":"x-6tu1vP-UpgradePlanModal-plans","selected":"x-6tu1vP-UpgradePlanModal-selected"});
...
class BillingButton extends react__WEBPACK_IMPORTED_MODULE_0__.Component {
  openBilling() {
    jsreport_studio__WEBPACK_IMPORTED_MODULE_1___default().openTab({
      key: 'Billing',
      editorComponentKey: 'billing',
      title: 'Billing'
    });
  }
  componentDidMount() {
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      className: "fa fa-usd"
    }), " ", Math.round((jsreport_studio__WEBPACK_IMPORTED_MODULE_1___default().authentication).user.tenant.creditsUsed / 1000), " / ", (jsreport_studio__WEBPACK_IMPORTED_MODULE_1___default().authentication).user.tenant.creditsAvailable);
  }
}
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (BillingButton);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ChangePasswordModal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
/* harmony import */ var jsreport_studio__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
/* harmony import */ var jsreport_studio__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jsreport_studio__WEBPACK_IMPORTED_MODULE_1__);
...
function ChangePasswordSettingsButton(props) {
  let ui = null;
  if ((jsreport_studio__WEBPACK_IMPORTED_MODULE_1___default().authentication).user.isSuperAdmin) {
    ui = /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("a", {
      id: "changePassword",
      onClick: () => jsreport_studio__WEBPACK_IMPORTED_MODULE_1___default().openModal(_ChangePasswordModal_js__WEBPACK_IMPORTED_MODULE_0__["default"], {
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var jsreport_studio__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(0);
...
class ChangePasswordModal extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor() {
    super();
    this.state = {};
    this.oldPasswordRef = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createRef();
    this.newPassword1Ref = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createRef();
    this.newPassword2Ref = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createRef();
  }
  async changePassword() {
    ...
    try {
      ...
      const response = await jsreport_studio__WEBPACK_IMPORTED_MODULE_3___default().api.post('/api/password', {
        data: data
      });
  ...
  render() {
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    ...
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("label", null, "old password"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("input", {
      type: "password",
      ref: this.oldPasswordRef
    })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
      className: "form-group"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("label", null, "new password"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("input", {
      type: "password",
      ref: this.newPassword1Ref
    })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
      className: "form-group"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("label", null, "new password verification"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("input", {
      type: "password",
      ...
      style: {
        color: 'red',
        display: this.state.validationError ? 'block' : 'none'
      }
    }, this.state.validationError), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", {
      style: {
        color: 'red',
        display: this.state.passwordError ? 'block' : 'none'
      }
    }, "password doesn't match"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", {
      style: {
        color: 'red',
        display: this.state.apiError ? 'block' : 'none'
      }
    }, this.state.apiError)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(ChangePasswordModal, "propTypes", {
  close: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().func).isRequired,
  options: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object).isRequired
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _ChangeEmailModal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(15);
/* harmony import */ var jsreport_studio__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);
/* harmony import */ var jsreport_studio__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jsreport_studio__WEBPACK_IMPORTED_MODULE_1__);
...
function ChangeEmailSettingsButton(props) {
  ...
  if ((jsreport_studio__WEBPACK_IMPORTED_MODULE_1___default().authentication).user.isSuperAdmin) {
    ui = /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("a", {
      id: "changeEmail",
      onClick: () => jsreport_studio__WEBPACK_IMPORTED_MODULE_1___default().openModal(_ChangeEmailModal_js__WEBPACK_IMPORTED_MODULE_0__["default"], {
        entity: (jsreport_studio__WEBPACK_IMPORTED_MODULE_1___default().authentication).user
      }),
      style: {
        cursor: 'pointer'
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ChangeEmailSettingsButton);
...
class ChangeEmailModal extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor() {
    super();
    this.state = {
      loading: false,
    ...
    this.newEmailRef = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createRef();
  }
  componentDidMount() {
  ...
  async changeEmail() {
    try {
      ...
      const response = await jsreport_studio__WEBPACK_IMPORTED_MODULE_3___default().api.post('/api/account-email', {
        data: data
      });
      this.setState({
        loading: false
  ...
  render() {
    ...
    if (completed) {
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
        ...
        className: "form-group"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("i", null, "Email changed successfully. Now we need to reload the studio..")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
        className: "button-bar"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("button", {
        autoFocus: true,
        className: "button confirmation",
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
      key: "edit"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p", null, "Please understand the change of the administrator email can break your API calls in case you use it in the authorization header. In this case, we recommend creating a custom jsreport user and use it in the API calls instead."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p", null, "Afterward, it is safe to change the administrator email."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p", null, "Please note that after the email is changed, you will be logged out and log in will be required."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
      className: "form-group"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("label", null, "current email"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("b", null, (jsreport_studio__WEBPACK_IMPORTED_MODULE_3___default().authentication).user.name))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
      className: "form-group"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("label", null, "new email"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("input", {
      type: "email",
...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(ChangeEmailModal, "propTypes", {
  close: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().func).isRequired,
  options: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object).isRequired
});
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ChangeEmailModal);
...
class AboutModal extends react__WEBPACK_IMPORTED_MODULE_1__.Component {
  render() {
    const {
      extensions
    } = this.props.options;
    ...
    })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null, "jsreportonline version: ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("b", null, version)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null, "jsreport version: ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("b", null, jsreportVersion)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null, "See more information about the jsreportonline release process and also release notes"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("br", null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("a", {
      className: "button confirmation",
...
_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(AboutModal, "propTypes", {
  options: (prop_types__WEBPACK_IMPORTED_MODULE_2___default().object).isRequired
});
...
/* harmony export */ });
/* harmony import */ var _addYears_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(18);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _addMonths_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(19);
...
/* harmony import */ var _constructFrom_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(21);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
...
/* harmony import */ var _BillingEditor_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(7);
/* harmony import */ var _BillingButton_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
/* harmony import */ var _ChangePasswordSettingsButton__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
/* harmony import */ var _ChangeEmailSettingsButton__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(14);
/* harmony import */ var _AboutModal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(16);
...
jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().addEditorComponent('billing', _BillingEditor_js__WEBPACK_IMPORTED_MODULE_1__["default"]);
jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().setAboutModal(_AboutModal__WEBPACK_IMPORTED_MODULE_5__["default"]);
jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().readyListeners.push(() => {
  const pendingModalsLaunch = [];
  const creditsExceeded = Math.round((jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().authentication).user.tenant.creditsUsed / 1000) > (jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().authentication).user.tenant.creditsAvailable;
  const creditsExceededModal = () => jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().openModal(props => {
    const creditsAvailable = (jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().authentication).user.tenant.creditsAvailable;
    const creditsUsed = Math.round((jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().authentication).user.tenant.creditsUsed / 1000);
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", null, "The monthly prepaid credits in your account has been exceeded. Please upgrade your ", /*#__PURE__*/React.createElement("a", {
      href: "https://jsreport.net/buy/online",
      rel: "noreferrer",
      target: "_blank"
    }, "jsreportonline plan"), " to avoid service interruption."), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("b", null, "Available:", ' ', /*#__PURE__*/React.createElement("span", {
      style: {
        color: '#008000'
      }
    }, creditsAvailable)), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("b", null, "Used:", ' ', /*#__PURE__*/React.createElement("span", {
      style: {
        color: '#c7a620'
      }
    }, creditsUsed)), /*#__PURE__*/React.createElement("br", null), /*#__PURE__*/React.createElement("b", null, "Excess:", ' ', /*#__PURE__*/React.createElement("span", {
      style: {
        color: '#ff0000'
      }
    }, `${creditsUsed - creditsAvailable} (${Math.floor((creditsUsed - creditsAvailable) / creditsAvailable * 100)}%)`))), /*#__PURE__*/React.createElement("div", {
      className: "button-bar"
  ...
  setInterval(() => {
    if (pendingModalsLaunch.length === 0 || jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().isModalOpen()) {
      return;
    }
  ...
  if ((jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().authentication).user.tenant.plan !== 'free' && (jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().authentication).user.tenant.payments && (jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().authentication).user.tenant.payments.customer.product.subscription.plannedCancelation) {
    pendingModalsLaunch.push(() => jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().openModal(props => {
      return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("p", {
        style: {
          color: 'red'
        }
      }, "The subscription renewal failed because the bank rejected the payment!"), /*#__PURE__*/React.createElement("p", null, "Please visit the billing and update the payment, otherwise the subscription will be switched to the limited plan on ", jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().authentication.user.tenant.payments.customer.product.subscription.plannedCancelation.toLocaleDateString()));
    }));
  }
});
jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().initializeListeners.push(async () => {
  (jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().authentication).user.tenant.billingHistory = (jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().authentication).user.tenant.billingHistory || [];
  jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().authentication.user.tenant.billingHistory.sort((a, b) => b.billedDate.getTime() - a.billedDate.getTime());
  jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().addToolbarComponent(_BillingButton_js__WEBPACK_IMPORTED_MODULE_2__["default"], 'right');
  jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().addToolbarComponent(() => /*#__PURE__*/React.createElement("div", {
    className: "toolbar-button"
  }, /*#__PURE__*/React.createElement("a", {
    href: "https://jsreport.net/learn/online-faq",
    rel: "noreferrer",
    target: "_blank",
    style: {
      color: 'inherit',
  ...
  jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().addToolbarComponent(_ChangePasswordSettingsButton__WEBPACK_IMPORTED_MODULE_3__["default"], 'settings');
  jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().addToolbarComponent(_ChangeEmailSettingsButton__WEBPACK_IMPORTED_MODULE_4__["default"], 'settings');
});
...
jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().runListeners.push((request, entities) => {
  ...
  jsreport_studio__WEBPACK_IMPORTED_MODULE_0___default().openModal(() => /*#__PURE__*/React.createElement("div", null, "The recipes phantom-pdf, phantom-image, wkhtmltopdf, and electron-pdf are deprecated.", /*#__PURE__*/React.createElement("br", null), "We still keep them running, but in the future, we may need to stop the support because of the necessary OS updates which may break the recipes' underlying technologies.", /*#__PURE__*/React.createElement("br", null), "Please consider migrating to chrome-based recipes."));
});
})();
